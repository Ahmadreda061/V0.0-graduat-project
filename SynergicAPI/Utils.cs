...
namespace SynergicAPI
{
    public static class Utils
    {
        ...
        /// </summary>
        public static string UserAccountString => "UserAccount(Email, Username, Password, IsActive, IsVendor, fName, lName, Gender, bDate, PhoneNumber, UserBio, SocialAccounts, ProfilePicture, UserToken, RecommendationProfile)";
